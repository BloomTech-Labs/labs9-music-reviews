exports.up = function(knex, Promise) {
  return knex.schema
    ...
    .createTable('albumReview', function(alb) {
      ...
      alb.datetime('dateCreated').defaultTo('CURRENT_TIMESTAMP')
      alb.datetime('dateModified').defaultTo('CURRENT_TIMESTAMP')
      alb.integer('rating')
    ...
    .createTable('trackReview', function(trk) {
      ...
      trk.datetime('dateCreated').defaultTo('CURRENT_TIMESTAMP')
      trk.datetime('dateModified').defaultTo('CURRENT_TIMESTAMP')
      trk.integer('rating')
      trk.text('review')
