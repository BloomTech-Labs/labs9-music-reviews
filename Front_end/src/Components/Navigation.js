...
import {Navbar, NavItem, SideNav, SideNavItem, Icon, Button} from 'react-materialize';
...
class Navigation extends Component {
    ...
    render() {
        const LoggedIn = <Navbar className = 'blue' right>
                            <SideNav
                                trigger={<Button style = {{background: 'inherit', hover: 'none', border: 'none'}}><Icon large>menu</Icon></Button>}
        ...
        const LoggedOut = <Navbar className = 'blue' right>
