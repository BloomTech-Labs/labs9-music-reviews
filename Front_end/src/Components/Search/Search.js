...
class Search extends Component {
  ...
  componentDidMount() {
    if (this.props.cookies.get("access_token") && this.state.query) {
    ...
    axios
      .get(
        `${API_URL}?q=${this.state.query
          .split(" ")
          .join("%20")}&type=album%2Cartist%2Ctrack`,
  ...
  render() {
                  ...
                  >
                    <Col>
                      <Card key={album.id} style={cardStyle}>
                        <CardImg
                          src={!album.images[0] ? image : album.images[0].url}
                          alt={album.name}
                  ...
                  >
                    <Col>
                      <Card style={cardStyle}>
                        <CardImg
                          src={!artist.images[0] ? image : artist.images[0].url}
                          alt={artist.name}
                          style={{ borderRadius: "50%", width: "7rem" }}
                        />
                        <CardBody>
    ...
    return (
      <Container fluid>
        ...
        {this.state.query.length <= 1 || !this.state.query
          ? null
          : renderSearch}
      </Container>
    );
